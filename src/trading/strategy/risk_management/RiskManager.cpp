...
#include "trading/strategy/TradeEngineCfgHashMap.hpp"
#include "common/constants/constants.hpp"

namespace trading::strategy::risk_management
{
    RiskManager::RiskManager(common::logging::Logger* logger, const PositionKeeper* positionKeeper, const TradeEngineCfgHashMap& tickerCfg)
    : _logger(logger)
    {
